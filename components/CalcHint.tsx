    ...
    <div className={`group relative ${className ?? ""}`}>
      ...
      <div
        ...
        className={`pointer-events-none absolute z-20 w-max max-w-[16rem]
                    border-2 border-[var(--ink)] bg-[var(--surface)] px-2.5 py-2 text-[10px]
                    leading-relaxed text-[var(--foreground)] opacity-0
                    shadow-[3px_3px_0_0_var(--shadow-hard)] transition-opacity duration-100
                    group-hover:opacity-100 group-focus-within:opacity-100 ${position}`}
      >
        {hint}
      </div>
    </div>
